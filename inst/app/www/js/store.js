$(document).keydown(function (event) {
  ...
  if (event.metaKey === false && event.ctrlKey === false && event.shiftKey === false) {
    ...
    if ($("#reg_store_res_name").is(":focus") && event.keyCode == 13) {
      ...
      $("#nb_store_pred").click();
    } else if ($("#neural_network_store_res_name").is(":focus") && event.keyCode == 13) {
      $("#neural_network_store_res").click();
    } else if ($("#neural_network_store_pred_name").is(":focus") && event.keyCode == 13) {
      $("#neural_network_store_pred").click();
