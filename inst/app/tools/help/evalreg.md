...
Select one or more variables that can be used to _predict_ the value of the response variable. This could be a variable or predicted values from a model (e.g., from a regression estimated using _sklearn > Linear regression (OLS)_ or a Neural Network estimated using _sklearn > Neural Network_).
...
For an overview of related R-functions used by Radiant to evaluate regression models see <a href = "https://radiant-rstats.github.io/radiant.model/reference/index.html#section-model-evaluate-regression" target="_blank">_sklearn > Evaluate regression_</a>